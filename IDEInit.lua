...
_G.IsIDE = true;
require 'script/campaign/mod/a_crp_deco_patch'
require 'script/campaign/mod/a_mighty_campaigns_controlled_characters'
...
a_crp_deco_patch();
a_mighty_campaigns_controlled_characters();


--[[local MC_CC_FactionTurnStart = {
    Key = "MC_CC_FactionTurnStart",
    Context = {
        faction = function()
            return humanFaction;
        end,
...
mock_listeners:trigger_listener(MC_CC_FactionTurnStart);--]]

testCharacter.faction = function()
    return testFaction;
end;
local MC_CC_CharacterCreated = {
    Key = "MC_CC_CharacterCreated",
    Context = {
        character = function()
            return testCharacter;
        end,
...
turn_number = 2;
mock_listeners:trigger_listener(MC_CC_CharacterCreated);


if false or (true and true and true and true and true) then
    local test = "";
end



local MC_CC_CharacterConvalescedOrKilled_123 = {
    Key = "MC_CC_CharacterConvalescedOrKilled_123",
    Context = {
        character = function()
            return testCharacter;
        end,
...
turn_number = 2;
testCharacter.is_wounded = function() return true; end;
mock_listeners:trigger_listener(MC_CC_CharacterConvalescedOrKilled_123);